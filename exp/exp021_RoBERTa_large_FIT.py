...
class Config:
    ...
    out_dir = '../out/' + filename + '/roberta-large-5-epochs' + str(epochs)
...
class CommonLitModel(nn.Module):
    def __init__(self, model_name, config, multisample_dropout=Config.multisample_dropout, output_hidden_states=False):
